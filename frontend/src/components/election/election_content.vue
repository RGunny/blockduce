<template>
  <div>
    <div class="product">
      <div class="imgbox">
        <img
          src="https://cdn.sporbiz.co.kr/news/photo/201904/333476_248785_1050.png"
        />
      </div>
      <div class="specifies">
        <h2>
        ...
        <div class="center content-inputs">
          <!-- <vs-input v-model="value" placeholder="1500DBC" /> -->
          <vs-input placeholder="1500DBC" />
        </div>
        <div class="button_container" onclick="this.classList.toggle('active')">
