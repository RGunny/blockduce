...
export default new Vuex.Store({
  ...
  actions: {
    fetchGenres({ commit }) {
      axios
        .get(SERVER.URL + SERVER.ROUTES.genres)
        .then((res) => {
    ...
    findMyAccount({ rootGetters, commit }) {
      axios
        .post(SERVER.URL + SERVER.ROUTES.myaccount, null, rootGetters.config)
        .then((res) => {
    ...
    fetchBooks({ commit }) {
      axios
        .get(SERVER.URL + SERVER.ROUTES.books)
        .then((res) => {
    ...
    createNoti({ getters }, notiData) {
      axios
        .post(SERVER.URL + SERVER.ROUTES.noti, notiData, getters.config)
        .catch((err) => console.log(err.response.data));
    },
    deleteNoti({ getters }, notiId) {
      axios
        .delete(SERVER.URL + SERVER.ROUTES.noti + '/' + notiId, getters.config)
        .catch((err) => console.log(err.response.data));
    },
    logout({ commit }) {
